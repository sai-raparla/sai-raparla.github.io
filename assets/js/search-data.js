      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/books/pride_and_prejudice/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%61%69%72%61%70%61%72%6C%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/leela-sai-raparla", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sai-raparla", "_blank");
        },
      },{
      id: 'light-theme',
